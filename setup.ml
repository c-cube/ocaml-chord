...
(* OASIS_START *)
(* DO NOT EDIT (digest: 10e5248b7f519b01fca258d7d407fcda) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("chord", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("chord", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/ocaml-chord";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("bencode", None);
                           FindlibPackage ("bencode_rpc", None);
                   ...
                   {
                      lib_modules = ["Dht"; "DhtBroadcast"; "Broadcast"];
                      lib_pack = true;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "documentation for Chord";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/ocaml-chord/tree/master/src";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "T\020\252\176k/\245R#Z\154*\202\027M}";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
